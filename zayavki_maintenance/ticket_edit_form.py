...
class TicketEditForm:
    def __init__(self, master, db, ticket_id, parent_window):
        ...
        self.label_ticket_number = tk.Label(
            master, text="Заявка №:", font="Tahoma 10 normal roman", bg="#D5F1E1")
        ...
        self.label_equipment = tk.Label(
            master, text="Оборудование:", font="Tahoma 10 normal roman", bg="#D5F1E1")
        ...
        self.label_fault_type = tk.Label(
            master, text="Тип неисправности:", font="Tahoma 10 normal roman", bg="#D5F1E1")
        ...
        self.label_problem_description = tk.Label(
            master, text="Описание проблемы:", font="Tahoma 10 normal roman", bg="#D5F1E1")
        ...
        self.label_client = tk.Label(
            master, text="Клиент:", font="Tahoma 10 normal roman", bg="#D5F1E1")
        ...
        self.label_status = tk.Label(
            master, text="Статус:", font="Tahoma 10 normal roman", bg="#D5F1E1")
        ...
        self.btn_submit = tk.Button(
            master, text="Сохранить", font="Tahoma 10 normal roman", bg="#3C5B91", fg="white", command=self.save)
    ...
    def save(self):
        ...
        if ticket_data['status'] == "Выполнено":
            ticket_data['completion_date'] = datetime.now().strftime(
                "%d.%m.%Y %H:%M:%S")  # Устанавливаем текущую дату и время
        self.db.update_ticket(self.ticket_id, ticket_data)
        # Обновление информации в родительском окне
